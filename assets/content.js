/* ============================================================
   Bilingual content for Damian Kowalczyk's portfolio.
   Edit text here — the page renders from this object.
   ============================================================ */
window.PORTFOLIO = {
  links: {
    github: "https://github.com/DamianKowalczykDK",
    linkedin: "https://www.linkedin.com/in/damian-kowalczyk-283a4232a",
    email: "" // <-- opcjonalnie: wpisz swój email, np. "damian@example.com"
  },
  ...
  ui: {
    pl: {
      ...
      theme_label: "Motyw",
      hero_layout: "Układ zdjęcia",
      hero_layout_bg: "Portret w tle",
      hero_layout_card: "Karta",
      scroll: "Przewiń",
      available: "Status",
    },
    en: {
      ...
      theme_label: "Theme",
      hero_layout: "Photo layout",
      hero_layout_bg: "Background",
      hero_layout_card: "Card",
      scroll: "Scroll",
      available: "Status",
    }
  },
  ...
  skills: [
    ...
    {
      category: { pl: "Architektura i Frameworki", en: "Architecture & Frameworks" },
      items: ["FastAPI", "Flask", "REST API", "Mikroserwisy", "SOLID", "Clean Architecture"]
    },
    {
      category: { pl: "Bazy danych", en: "Databases" },
      items: ["MySQL", "MongoDB", "SQLAlchemy", "Beanie ODM", "Alembic", "Optymalizacja zapytań"]
    },
    {
      category: { pl: "DevOps i ekosystem", en: "DevOps & Ecosystem" },
      items: ["Docker", "Docker Compose", "Kubernetes", "Nginx", "Git", "Linux", "Poetry", "Pipenv"]
    },
    {
      category: { pl: "Jakość kodu i testy", en: "Code quality & Testing" },
      items: ["Pytest", "Pydantic", "mypy", "ruff", "Clean Code"]
    },
    {
      category: { pl: "Bezpieczeństwo i integracje", en: "Security & Integrations" },
      items: ["JWT", "MFA (TOTP)", "RBAC", "HTTPX", "Fakturownia API", "ElevenLabs API"]
    },
    {
      category: { pl: "AI / LLM / NLP", en: "AI / LLM / NLP" },
      items: ["OpenAI", "Ollama", "Gemini", "LangChain", "Prompt engineering", "BeautifulSoup"]
    }
  ],
